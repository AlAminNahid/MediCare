...
export const doctorApi = {
  ...
  updateAppointment: (id: number, data: object) =>
    request(`/doctor/appointments/${id}`, {
      method: "PATCH",
  ...
  createPrescription: (data: object) =>
    request("/doctor/prescriptions", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updatePrescription: (id: number, data: object) =>
    request(`/doctor/prescriptions/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
  ...
  updateChamber: (id: number, data: object) =>
    request(`/doctor/chambers/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
  deleteChamber: (id: number) =>
    request(`/doctor/chambers/${id}`, { method: "DELETE" }),
